...
> tl;dr: We've got a project board with epics and features. We use PRs as change log and as materialized features. Find it [here](https://github.com/orgs/Talomia/projects).
...
You can find the [epics as issues](https://github.com/Talomia/Talos/labels/epic) which are probably never
going to be closed.
