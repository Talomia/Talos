...
export const BaseChat = React.forwardRef<HTMLDivElement>((_, ref) => {
  const {
    chat: { messages, input, chatStarted, isStreaming, data, enhancingPrompt },
    ...
    actions: { sendMessage, handleStop, handleInputChange, enhancePrompt, importChat, exportChat },
    ui: {
      showChat,
      chatMode,
      setChatMode,
    ...
    aiSdk: { append, addToolResult, onWebSearchResult },
    refs: { textareaRef },
  } = useChatContext();
