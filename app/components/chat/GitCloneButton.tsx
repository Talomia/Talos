...
import { detectProjectCommands, createCommandsMessage, escapeXmlTags } from '~/utils/projectCommands';
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-transparent hover:bg-ui-background-depth-1 dark:hover:bg-ui-background-depth-1 text-ui-textSecondary dark:text-ui-textSecondary hover:text-ui-textPrimary dark:hover:text-ui-textPrimary transition-all duration-200 hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full p-4 rounded-lg bg-ui-background-depth-1 dark:bg-ui-background-depth-1 hover:bg-ui-background-depth-2 dark:hover:bg-ui-background-depth-2 border border-ui-borderColor dark:border-ui-borderColor hover:border-ui-borderColorActive dark:hover:border-ui-borderColorActive transition-all duration-200 text-left group"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-ui-textPrimary dark:text-ui-textPrimary">GitHub</div>
                      <div className="text-sm text-ui-textSecondary dark:text-ui-textSecondary">
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-ui-textPrimary dark:text-ui-textPrimary">GitLab</div>
                      <div className="text-sm text-ui-textSecondary dark:text-ui-textSecondary">
