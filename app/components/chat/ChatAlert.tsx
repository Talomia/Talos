...
export default function ChatAlert({ alert, clearAlert, postMessage }: Props) {
  ...
  const message = isPreview
    ? 'We encountered an error while running the preview. Would you like me to analyze and help resolve this issue?'
    : 'We encountered an error while running terminal commands. Would you like me to analyze and help resolve this issue?';
    ...
    <AnimatePresence>
      ...
      >
        <div className="flex items-start">
          ...
          >
            <div className={`i-ph:warning-duotone text-xl text-ui-button-danger-text`}></div>
          </motion.div>
          {/* Content */}
              ...
              <div className={classNames(' flex gap-2')}>
                <button
                  ...
                  className={classNames(
                    ...
                    'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ui-button-danger-background',
