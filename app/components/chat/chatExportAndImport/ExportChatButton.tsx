    ...
    <div className="flex border border-ui-borderColor rounded-md overflow-hidden">
      <DropdownMenu.Root>
        ...
        >
          <DropdownMenu.Item
            className={classNames(
              'cursor-pointer flex items-center w-auto px-4 py-2 text-sm text-ui-textPrimary hover:bg-ui-item-backgroundActive gap-2 rounded-md group relative',
            )}
            onClick={() => {
