  ...
  return (
    <>
      <div className="artifact border border-ui-borderColor flex flex-col overflow-hidden rounded-lg w-full transition-border duration-150">
        <div className="flex">
          <button
            className="flex items-stretch bg-ui-artifacts-background hover:bg-ui-artifacts-backgroundHover w-full overflow-hidden"
            onClick={() => {
          ...
          >
            <div className="px-5 p-3.5 w-full text-left">
              ...
              <div className="w-full text-ui-textSecondary text-xs mt-0.5">Click to open Workbench</div>
            </div>
          </button>
          {artifact.type !== 'bundled' && <div className="bg-ui-artifacts-borderColor w-[1px]" />}
          <AnimatePresence>
        ...
        {artifact.type === 'bundled' && (
          <div className="flex items-center gap-1.5 p-5 bg-ui-actions-background border-t border-ui-artifacts-borderColor">
            ...
            <div className="text-ui-textPrimary font-medium leading-5 text-sm">
...
function getIconColor(status: ActionState['status']) {
  switch (status) {
    ...
    case 'running': {
      return 'text-ui-loader-progress';
    }
    case 'complete': {
      return 'text-ui-icon-success';
    }
    case 'aborted': {
      return 'text-ui-textSecondary';
    }
    case 'failed': {
      return 'text-ui-icon-error';
    }
    default: {
      return undefined;
    }
