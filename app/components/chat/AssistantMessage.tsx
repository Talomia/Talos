                  ...
                  {onRewind && (
                    <WithTooltip tooltip="Revert to this message">
                      <button
                        ...
                        className="i-ph:arrow-u-up-left text-xl text-ui-textSecondary hover:text-ui-textPrimary transition-colors"
                      />
                    </WithTooltip>
                  )}
                  {onFork && (
                    <WithTooltip tooltip="Fork chat from this message">
                      <button
                        ...
                        key="i-ph:git-fork"
                        className="i-ph:git-fork text-xl text-ui-textSecondary hover:text-ui-textPrimary transition-colors"
                      />
                    </WithTooltip>
                  )}
                </div>
