          ...
          >
            <div
              className={classNames(
                'text-xl',
                type === 'success'
                  ? 'i-ph:check-circle-duotone text-ui-icon-success'
                  : type === 'error'
                    ? 'i-ph:warning-duotone text-ui-button-danger-text'
                    : 'i-ph:info-duotone text-ui-loader-progress',
              )}
            ></div>
          </motion.div>
          {/* Content */}
                ...
                <div className="mt-4 mb-2">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <div
                      className={classNames(
                        'h-0.5 w-8',
                        buildStatus === 'complete' ? 'bg-ui-icon-success' : 'bg-ui-textTertiary',
                      )}
                    ></div>
              ...
              {url && type === 'success' && (
                <div className="mt-2">
                  <a
                    ...
                    className="text-ui-item-contentAccent hover:underline flex items-center"
                  >
