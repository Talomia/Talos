  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-ui-borderColor bg-ui-background-depth-1 text-ui-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-ui-textSecondary', className)} {...props} />;
  },
);
