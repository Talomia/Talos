...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={classNames(
      'inline-flex h-10 items-center justify-center rounded-md bg-ui-background-depth-1 p-1 text-ui-textSecondary border border-ui-borderColor',
      className,
    )}
    {...props}
  />
