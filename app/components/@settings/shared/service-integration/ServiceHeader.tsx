      ...
      <>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-ui-textPrimary dark:text-ui-textPrimary">{title}</h2>
          </div>
          <div className="flex items-center gap-2">
            {additionalInfo}
            {onTestConnection && (
        ...
        {description && <p className="text-sm text-ui-textSecondary dark:text-ui-textSecondary">{description}</p>}
      </>
    );
  },
);
