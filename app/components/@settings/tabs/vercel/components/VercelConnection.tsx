...
export default function VercelConnection() {
  ...
  return (
    <motion.div
      className="bg-ui-background-depth-1 rounded-lg border border-ui-borderColor"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <h3 className="text-base font-medium text-ui-textPrimary">Vercel Connection</h3>
          </div>
        </div>
        ...
        {!connection.user ? (
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-2 text-sm text-ui-textSecondary">
                ...
                <div className="mt-2 text-xs text-ui-textSecondary bg-ui-background-depth-1 p-2 rounded">
                  <p className="flex items-center gap-1">
                    ...
                    <code className="px-1 py-0.5 bg-ui-background-depth-2 rounded text-xs">
                ...
                <div className="mt-2 text-xs text-ui-textTertiary">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 bg-ui-background-depth-2 rounded-lg">
              {/* Debug output */}
              ...
              />
              <div>
                <h4 className="text-sm font-medium text-ui-textPrimary">
            ...
            {fetchingStats ? (
              ...
              <div>
                <button
                  ...
                  className="w-full bg-transparent text-left text-sm font-medium text-ui-textPrimary mb-3 flex items-center gap-2"
                >
                  ...
                  <div className="grid gap-3">
                    {connection.stats.projects.map((project) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block p-4 rounded-lg border border-ui-borderColor hover:border-ui-borderColorActive transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div>
                              ...
                              {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                                <>
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="hover:text-ui-borderColorActive"
                                  >
                          ...
                          {project.framework && (
                            <div className="text-xs text-ui-textSecondary px-2 py-1 rounded-md bg-ui-background-depth-3">
                              <span className="flex items-center gap-1">
