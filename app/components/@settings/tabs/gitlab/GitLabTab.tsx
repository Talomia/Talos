  ...
  return (
    <div className="space-y-6">
      ...
      {connection?.user && (
        ...
        >
          <div className="flex items-center gap-4 p-4 bg-ui-background-depth-1 rounded-lg">
            <div className="w-12 h-12 rounded-full border-2 border-ui-item-contentAccent flex items-center justify-center bg-ui-background-depth-2 overflow-hidden">
              ...
              connection.user.avatar_url !== '' ? (
                ...
                <div className="w-full h-full rounded-full bg-ui-item-contentAccent flex items-center justify-center text-white font-semibold text-sm">
            ...
            <div>
              ...
              <p className="text-sm text-ui-textSecondary">{connection.user?.username}</p>
            </div>
          </div>
        </motion.div>
      )}
      ...
      {connection?.stats && (
        <motion.div
          ...
          className="border-t border-ui-borderColor pt-6"
        >
          <h3 className="text-base font-medium text-ui-textPrimary mb-4">Statistics</h3>
          <StatsDisplay
