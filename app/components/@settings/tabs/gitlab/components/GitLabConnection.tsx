        ...
        {!isConnected && (
          <div className="text-xs text-ui-textSecondary bg-ui-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              ...
              <code className="px-1 py-0.5 bg-ui-background-depth-2 rounded">VITE_GITLAB_ACCESS_TOKEN</code> environment
              variable to connect automatically.
            </p>
            <p>
              For self-hosted GitLab instances, also set{' '}
              <code className="px-1 py-0.5 bg-ui-background-depth-2 rounded">
