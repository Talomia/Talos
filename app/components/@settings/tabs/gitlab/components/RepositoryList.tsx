  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-sm font-medium text-ui-textPrimary">Repositories ({filteredRepositories.length})</h4>
        {onRefresh && (
          <Button
            onClick={onRefresh}
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 rounded-lg bg-ui-background-depth-2 border border-ui-borderColor text-ui-textPrimary placeholder-ui-textTertiary focus:outline-none focus:ring-1 focus:ring-ui-borderColorActive"
        />
        <div className="absolute left-3 top-1/2 -translate-y-1/2">
          {isSearching ? (
            <div className="i-ph:spinner animate-spin w-4 h-4 text-ui-textSecondary" />
          ) : (
            <div className="i-ph:magnifying-glass w-4 h-4 text-ui-textSecondary" />
          )}
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredRepositories.length === 0 ? (
          <div className="text-center py-8 text-ui-textSecondary">
