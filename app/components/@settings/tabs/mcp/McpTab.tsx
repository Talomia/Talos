    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-ui-textPrimary">MCP Servers Configured</h2>{' '}
          <button
            onClick={checkServerAvailability}
            disabled={isCheckingServers || !parsedConfig || serverEntries.length === 0}
            className={classNames(
              'px-3 py-1.5 rounded-lg text-sm',
              'bg-ui-background-depth-3 hover:bg-ui-background-depth-4',
              'text-ui-textPrimary',
          ...
          >
            {isCheckingServers ? (
              <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-ui-loader-progress animate-spin" />
            ) : (
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-ui-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-ui-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
          ...
          <div>{error && <p className="mt-2 mb-2 text-sm text-ui-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-ui-textSecondary mb-2">
          ...
          <div className="mt-2 text-sm text-ui-textSecondary">
            ...
            <a
              ...
              className="text-ui-link hover:underline inline-flex items-center gap-1"
            >
      ...
      <div className="flex flex-wrap justify-between gap-3 mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm border border-ui-borderColor
        ...
        <div className="flex gap-2">
          <button
            ...
            className={classNames(
              ...
              'hover:bg-ui-item-backgroundActive',
              'disabled:opacity-50 disabled:cursor-not-allowed',
            )}
          >
