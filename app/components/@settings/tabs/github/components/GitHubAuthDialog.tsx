  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-ui-background border border-ui-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              ...
              <div className="text-xs text-ui-textSecondary bg-ui-background-depth-1 p-3 rounded-lg">
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-4 py-2 text-sm text-ui-textSecondary hover:text-ui-textPrimary"
                  >
                    Cancel
                  </button>
                  <button
