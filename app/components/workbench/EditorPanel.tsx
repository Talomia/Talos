                      ...
                      <Tabs.List className="h-full flex-shrink-0 flex items-center">
                        <Tabs.Trigger
                          ...
                          className={classNames(
                            'h-full bg-transparent hover:bg-ui-background-depth-3 py-0.5 px-2 rounded-lg text-sm font-medium text-ui-textTertiary hover:text-ui-textPrimary data-[state=active]:text-ui-textPrimary',
                          )}
                        >
                          Files
                        </Tabs.Trigger>
