          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-ui-background-depth-1 rounded-xl shadow-2xl border border-ui-borderColor overflow-hidden">
                  <div className="p-3 border-b border-ui-borderColor">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-ui-textPrimary">Window Options</span>
                    </div>
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            showDeviceFrame ? 'bg-[#6D28D9]' : 'bg-ui-background-depth-3'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                            isLandscape ? 'bg-[#6D28D9]' : 'bg-ui-background-depth-3'
                          } relative`}
                          onClick={(e) => {
                            e.stopPropagation();
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-ui-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-[#F5EEFF] dark:hover:bg-gray-900 bg-ui-background-depth-1"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-ui-icon-secondary group-hover:text-[#6D28D9] transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        <span className="font-medium group-hover:text-[#6D28D9] transition-colors duration-200">
                          {size.name}
                        </span>
                        <span className="text-xs text-ui-textTertiary group-hover:text-[#6D28D9] transition-colors duration-200">
