...
import { useScreenshotContext } from '~/lib/contexts/ScreenshotContext';
...
const ScreenshotSelectorInner = ({ isSelectionMode, setIsSelectionMode, containerRef }: ScreenshotSelectorProps) => {
  const { uploadedFiles, setUploadedFiles, imageDataList, setImageDataList } = useScreenshotContext();
  ...
  const handleCopySelection = useCallback(async () => {
    ...
    try {
      ...
      reader.onload = (e) => {
        ...
        // Update the files and image data via context
...
export const ScreenshotSelector = memo(ScreenshotSelectorInner);
