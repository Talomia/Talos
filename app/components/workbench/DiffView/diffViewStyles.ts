export const lineNumberStyles =
  'w-9 shrink-0 pl-2 py-1 text-left font-mono text-ui-textTertiary border-r border-ui-borderColor bg-ui-background-depth-1';
export const lineContentStyles =
  'px-1 py-1 font-mono whitespace-pre flex-1 group-hover:bg-ui-background-depth-2 text-ui-textPrimary';
