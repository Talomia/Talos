  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-ui-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-ui-background-depth-2 border-y border-ui-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-ui-terminals-buttonBackground text-ui-textSecondary hover:text-ui-textPrimary': isActive,
                          'bg-ui-background-depth-2 text-ui-textSecondary hover:bg-ui-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-ui-terminals-buttonBackground text-ui-textPrimary': isActive,
                            'bg-ui-background-depth-2 text-ui-textSecondary hover:bg-ui-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-ui-textTertiary hover:text-ui-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachAppTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachAppTerminal(terminal)}
