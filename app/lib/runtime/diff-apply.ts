/**
 * Diff Apply — Client-safe Diff Parsing & Application
 * ====================================================
 * This module re-exports the pure diff logic so it can be used from
 * client-side code (e.g. the action runner). The canonical implementation
 * lives in `app/lib/.server/llm/diff-editor.ts` but that file is behind
 * the `.server` boundary and cannot be imported from client modules.
 *
 * If you change the diff algorithm, update BOTH files.
 */

import { createScopedLogger } from '~/utils/logger';

const logger = createScopedLogger('diff-apply');
